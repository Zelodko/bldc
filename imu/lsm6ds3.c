...
static THD_FUNCTION(lsm6ds3_thread, arg) {
	...
	// One tick less to ensure the frequency is at least the configured one or a bit higher (TIME_US2I rounds up)
	const systime_t interval = TIME_US2I(1000000 / rate_hz) - 1;

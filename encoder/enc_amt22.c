...
// TODO: not hardware-tested on H7 - ported from upstream release_7_00, no AMT22 hardware
// exists for this port yet. Also fixed a copy-paste bug from upstream: the original used
// sizeof(AS504x_state) here instead of sizeof(AMT22_state), which would have zeroed past
// the end of cfg->state.
